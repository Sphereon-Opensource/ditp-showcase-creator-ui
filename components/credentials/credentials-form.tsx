...
export const CredentialsForm = () => {
  const { selectedCredential, mode, setSelectedCredential, viewCredential } =
    useCredentials();
  ...
  const { setIssuerId, setSelectedCredentialDefinitionIds, setRelayerId } =
    useHelpersStore();
